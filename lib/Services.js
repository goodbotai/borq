...
function init(conversation) {
  ...
  */
  function genRapidproContact(groups, language, {first_name: firstName,
                                                 last_name: lastName,
                                                 profile_pic,
                                                 locale,
                                                 timezone,
  ...
  */
  function genAndPostRapidproContact(groups, language) {
    getFacebookProfile(messengerId)
      .then((facebookProfile) => {
        const contact = genRapidproContact(groups, language, facebookProfile);
